...
當M1B年增率上升時，大盤上揚；當M1B年增率下降，大盤下跌。兩者走勢一致。
...
ETF是將投資標的證券化的一種投資基金，讓投資者可以購買或贖回，可以賺取資本利得與股利。

也同時兼具封閉與開放兩種型態。

### 共同基金 開放型的共同基金有哪些特色？

由專業經理人操盤的基金，讓投資者可以購買或贖回，一樣可以賺取資本利得與股利。

註：沒什麼特色騙錢的，大部分長期都贏不了大盤。
...
簡單幾何平均就是把所有的報酬率加起來除以次數。(就正常算平均的概念)

幾何平均就是把所有報酬率乘起來開個相對應次數的***超爆裂***開根號。(7組資料就開7次方根)。
